...
Data are downloaded and unzipped by [python script](./download_data.py). 12 csv files are used in this project. All in the same format with one file representing one Beijing district. All data are combined and stored in`air_data`.
