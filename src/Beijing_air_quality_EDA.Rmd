...
**(2)** **the right of the purple vertical line**It is clear that the area under the curve for time_A in these two sections are larger than the area under the curve of time_B; which indicates time_A has more extreme values than time_B.  
The area under the curve of time_B dominates between the orange line and purple vertical line (it completely covered the area of time_A).  
There are overlapping areas, however, the distinct areas of time_A and time_B in this density plot suggests that time_A could possibly have a higher median than time_B. 
