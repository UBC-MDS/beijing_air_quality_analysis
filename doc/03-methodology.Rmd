...
We chose to divide our dataset into two equal time intervals in order to see if there is a general change in the PM2.5 levels across these two time periods. While we have considered other means of dividing the dataset, such as by year and mapping it according to government policies and its implementation, we made the decision not to, as we recognise that phasing out of certain pollutants will take time, and there is a time lag involved. 
